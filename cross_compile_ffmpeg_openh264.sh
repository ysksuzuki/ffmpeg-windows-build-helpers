...
build_libopenh264() {
  ...
  cd openh264
  sed -i -e "s|PREFIX=/usr/local|PREFIX=${mingw_w64_x86_64_prefix}|" Makefile
  do_make_and_make_install "OS=mingw_nt ARCH=x86_64 CC=$(echo $cross_prefix)gcc CXX=$(echo $cross_prefix)g++ AR=$(echo $cross_prefix)ar"
  cd ..
}
...
build_ffmpeg() {
  ...
  local extra_configure_opts="--extra-cflags=-DLIBTWOLAME_STATIC --extra-libs=-lstdc++ --extra-libs=-lpng --extra-libs=-loleaut32 " # --enable-libquvi
...
#  config_options="--arch=$arch --target-os=mingw32 --cross-prefix=$cross_prefix --pkg-config=pkg-config --enable-gpl --enable-libx264 --enable-avisynth --enable-libxvid --enable-libmp3lame --enable-version3 --enable-zlib --enable-librtmp --enable-libvorbis --enable-libtheora --enable-libspeex --enable-libopenjpeg --enable-gnutls --enable-libgsm --enable-libfreetype --enable-libopus --disable-w32threads --enable-frei0r --enable-filter=frei0r --enable-libvo-aacenc --enable-bzlib --enable-libxavs --extra-cflags=-DPTW32_STATIC_LIB --enable-libopencore-amrnb --enable-libopencore-amrwb --enable-libvo-amrwbenc --enable-libschroedinger --enable-libvpx --enable-libilbc --prefix=$mingw_w64_x86_64_prefix $extra_configure_opts --extra-cflags=$CFLAGS" # other possibilities: --enable-w32threads --enable-libflite
  ...
  config_options="--arch=$arch --target-os=mingw32 --cross-prefix=$cross_prefix --pkg-config=pkg-config --disable-debug --disable-ffplay --disable-ffserver --disable-doc --enable-gpl --enable-libopenh264 --enable-libmp3lame --enable-version3 --enable-zlib --enable-libvorbis --enable-libtheora --enable-libopus --enable-w32threads --enable-libvo-aacenc --enable-bzlib --extra-cflags=-DPTW32_STATIC_LIB --enable-libvpx --prefix=$mingw_w64_x86_64_prefix $extra_configure_opts --extra-cflags=$CFLAGS" # other possibilities: --enable-w32threads --enable-libflite
  if [[ "$non_free" = "y" ]]; then
